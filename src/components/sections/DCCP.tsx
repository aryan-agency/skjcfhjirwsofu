...
const DCCP = () => {
  return (
    <section id="dccp" className="py-24 bg-background">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          <div className="lg:col-span-2 reveal">
            <p className="text-sm font-semibold uppercase tracking-widest text-primary mb-3">
              DOCMED CANCER CARE PLAN
            </p>
          ...
          <div className="lg:col-span-3 reveal">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              DCCP members receive access to cancer screening support,
              oncology teleconsultations, treatment navigation assistance,
              hospital admission coordination, nutrition counselling,
              physiotherapy guidance, mental wellness support, and home-care
              resources.
            </p>
